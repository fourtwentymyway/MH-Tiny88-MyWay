...
#define ST7735_CHIPSET		4 // <= Set ST7735 LCD chipset/variation here (from above list)
...
#define	ST7735_DC_PIN		12			// <= DC pin (1=data or 0=command indicator line) also called RS
//#define	ST7735_RST_PIN		RESET			// <= RST pin (optional)
#define	ST7735_MOSI_PIN	11			// <= MOSI pin (if not hardware SPI)
//#define	ST7735_MISO_PIN	0			// <= MISO pin (if not hardware SPI)
#define	ST7735_SCLK_PIN	13			// <= SCLK pin (if not hardware SPI)
// (with hardware SPI some pins dictated by AVR PIN function - as shown above)
#define ST7735TFT_RST -1
