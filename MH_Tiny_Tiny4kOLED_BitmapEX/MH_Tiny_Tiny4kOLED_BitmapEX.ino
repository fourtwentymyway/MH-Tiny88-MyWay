...
void setup() {
  ...
  //oled.bitmap(0, 0, 24, 2, image);
   //64x64 centered 128x64SSD1306-(32, 0, 96, 8,...)\\
  oled.bitmap(32, 0, 96, 8, image);  
   //72x40 vertical 72x40SSD1306-(0, 0, 72, 5,...)
  oled.bitmap(0, 0, 72, 5, image); 
   //40x40 centered on 72x40SSD1306-(16, 0, 56, 5,...)\\
  oled.bitmap(16, 0, 56, 5, image);
   //24x24 centered 72x40SSD1306-(24,1, 48, 4,...)\\
